...
static struct {
    const char *name;
    int type;
} trap_types[] = { { "arrow", ARROW_TRAP_SET },
                   { "crossbow bolt", BOLT_TRAP_SET },
                   { "dart", DART_TRAP_SET },
                   ...
                   { "hole", HOLE },
                   { "trap door", TRAPDOOR },
                   { "teleport", TELEP_TRAP_SET },
                   { "level teleport", LEVEL_TELEP },
                   { "magic portal", MAGIC_PORTAL },
                   { "web", WEB },
                   { "statue", STATUE_TRAP },
                   { "magic", MAGIC_TRAP_SET },
                   { "anti magic", ANTI_MAGIC },
                   { "polymorph", POLY_TRAP_SET },
                   { "spear", SPEAR_TRAP_SET },
                   { "magic beam", MAGIC_BEAM_TRAP_SET },
...
char **argv;
{
    ...
    static char *mac_argv[] = {
        ...
        ":dat:Convict.des",    ":dat:DKnight.des",     ":dat:Druid.des",
        ":dat:Healer.des",     ":dat:Infidel.des",     ":dat:Knight.des",
        ":dat:Monk.des",       ":dat:Priest.des",      ":dat:Ranger.des",
        ":dat:Rogue.des",      ":dat:Samurai.des",     ":dat:Tourist.des",
        ":dat:Valkyrie.des",   ":dat:Wizard.des",      ":dat:bigroom.des",
        ":dat:castle.des",     ":dat:endgame.des",     ":dat:forest.des",
        ":dat:gehennom.des",   ":dat:goblintown.des",  ":dat:hdgn.des",
        ":dat:icequeen.des",   ":dat:knox.des",        ":dat:medusa.des",
        ":dat:mines.des",      ":dat:nymph.des",       ":dat:oracle.des",
        ":dat:purgatory.des",  ":dat:sokoban.des",     ":dat:tower.des",
        ":dat:vaults.des",     ":dat:vecna.des",       ":dat:yendor.des"
    };
