...
NHSUBDIR="evilhack-0.4.0"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/evilhack-0.4.0/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-evil040"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-evil040"
