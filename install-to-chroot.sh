...
NHSUBDIR="evilhack-0.7.0"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/evilhack-0.7.0/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-evil070"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-evil070"
