...
NHSUBDIR="evilhack-0.8.3"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/evilhack-0.8.3/var/"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-evil083"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-evil083"
