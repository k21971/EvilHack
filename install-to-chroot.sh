...
NHSUBDIR="evilhack-0.3.1"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/evilhack-0.3.1/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-evil031"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-evil031"
