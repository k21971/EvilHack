...
NHSUBDIR="evilhack-0.3.2"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/evilhack-0.3.2/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-evil032"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-evil032"
