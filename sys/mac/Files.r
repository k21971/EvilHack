...
read 'File' (1063,"oracle.lev") "oracle.lev";
read 'File' (1064,"oracles") "oracles";
read 'File' (1065,"orcus.lev") "orcus.lev";
//read 'File' (1066,"quest.dat") "quest.dat";
read 'File' (1067,"rumors") "rumors";
read 'File' (1068,"sanctum.lev") "sanctum.lev";
read 'File' (1069,"soko1-1.lev") "soko1-1.lev";
read 'File' (1070,"soko1-2.lev") "soko1-2.lev";
read 'File' (1071,"soko2-1.lev") "soko2-1.lev";
read 'File' (1072,"soko2-2.lev") "soko2-2.lev";
read 'File' (1073,"soko3-1.lev") "soko3-1.lev";
read 'File' (1074,"soko3-2.lev") "soko3-2.lev";
read 'File' (1075,"soko4-1.lev") "soko4-1.lev";
read 'File' (1076,"soko4-2.lev") "soko4-2.lev";
read 'File' (1077,"tower1.lev") "tower1.lev";
read 'File' (1078,"tower2.lev") "tower2.lev";
read 'File' (1079,"tower3.lev") "tower3.lev";
read 'File' (1080,"tower4.lev") "tower4.lev";
read 'File' (1081,"valley.lev") "valley.lev";
//read 'File' (1082,"vaults.dat") "vaults.dat";
read 'File' (1083,"vlt-0000.lev") "vlt-0000.lev";
read 'File' (1084,"vlt-0001.lev") "vlt-0001.lev";
read 'File' (1085,"vlt-0002.lev") "vlt-0002.lev";
read 'File' (1086,"vlt-0003.lev") "vlt-0003.lev";
read 'File' (1087,"vlt-0004.lev") "vlt-0004.lev";
read 'File' (1088,"vlt-0005.lev") "vlt-0005.lev";
read 'File' (1089,"vlt-0006.lev") "vlt-0006.lev";
read 'File' (1090,"vlt-0007.lev") "vlt-0007.lev";
read 'File' (1091,"vlt-0008.lev") "vlt-0008.lev";
read 'File' (1092,"vlt-0009.lev") "vlt-0009.lev";
read 'File' (1093,"vlt-0010.lev") "vlt-0010.lev";
read 'File' (1094,"vlt-0011.lev") "vlt-0011.lev";
read 'File' (1095,"vlt-0012.lev") "vlt-0012.lev";
read 'File' (1096,"vlt-0013.lev") "vlt-0013.lev";
read 'File' (1097,"vlt-0014.lev") "vlt-0014.lev";
read 'File' (1098,"vlt-0015.lev") "vlt-0015.lev";
read 'File' (1099,"vlt-0016.lev") "vlt-0016.lev";
read 'File' (1100,"vlt-0017.lev") "vlt-0017.lev";
read 'File' (1101,"vlt-0018.lev") "vlt-0018.lev";
read 'File' (1102,"vlt-0019.lev") "vlt-0019.lev";
read 'File' (1103,"vlt-0020.lev") "vlt-0020.lev";
read 'File' (1104,"vlt-0021.lev") "vlt-0021.lev";
read 'File' (1105,"vlt-0022.lev") "vlt-0022.lev";
read 'File' (1106,"vlt-0023.lev") "vlt-0023.lev";
read 'File' (1107,"vlt-0024.lev") "vlt-0024.lev";
read 'File' (1108,"vlt-0025.lev") "vlt-0025.lev";
read 'File' (1109,"vlt-0026.lev") "vlt-0026.lev";
read 'File' (1110,"vlt-0027.lev") "vlt-0027.lev";
read 'File' (1111,"vlt-0028.lev") "vlt-0028.lev";
read 'File' (1112,"vlt-0029.lev") "vlt-0029.lev";
read 'File' (1113,"vlt-0030.lev") "vlt-0030.lev";
read 'File' (1114,"vlt-0031.lev") "vlt-0031.lev";
read 'File' (1115,"water.lev") "water.lev";
read 'File' (1116,"wizard1.lev") "wizard1.lev";
read 'File' (1117,"wizard2.lev") "wizard2.lev";
read 'File' (1118,"wizard3.lev") "wizard3.lev";
read 'File' (1119,"yeenoghu.lev") "yeenoghu.lev";
...
read 'File' (1063,"oracle.lev") ":lib:oracle.lev";
read 'File' (1064,"oracles") ":lib:oracles";
read 'File' (1065,"orcus.lev") ":lib:orcus.lev";
read 'File' (1066,"quest.dat") ":lib:quest.dat";
read 'File' (1067,"rumors") ":lib:rumors";
read 'File' (1068,"sanctum.lev") ":lib:sanctum.lev";
read 'File' (1069,"soko1-1.lev") ":lib:soko1-1.lev";
read 'File' (1070,"soko1-2.lev") ":lib:soko1-2.lev";
read 'File' (1071,"soko2-1.lev") ":lib:soko2-1.lev";
read 'File' (1072,"soko2-2.lev") ":lib:soko2-2.lev";
read 'File' (1073,"soko3-1.lev") ":lib:soko3-1.lev";
read 'File' (1074,"soko3-2.lev") ":lib:soko3-2.lev";
read 'File' (1075,"soko4-1.lev") ":lib:soko4-1.lev";
read 'File' (1076,"soko4-2.lev") ":lib:soko4-2.lev";
read 'File' (1077,"tower1.lev") ":lib:tower1.lev";
read 'File' (1078,"tower2.lev") ":lib:tower2.lev";
read 'File' (1079,"tower3.lev") ":lib:tower3.lev";
read 'File' (1080,"tower4.lev") ":lib:tower4.lev";
read 'File' (1081,"valley.lev") ":lib:valley.lev";
read 'File' (1082,"vaults.dat") ":lib:vaults.dat";
read 'File' (1083,"vlt-0000.lev") ":lib:vlt-0000.lev";
read 'File' (1084,"vlt-0001.lev") ":lib:vlt-0001.lev";
read 'File' (1085,"vlt-0002.lev") ":lib:vlt-0002.lev";
read 'File' (1086,"vlt-0003.lev") ":lib:vlt-0003.lev";
read 'File' (1087,"vlt-0004.lev") ":lib:vlt-0004.lev";
read 'File' (1088,"vlt-0005.lev") ":lib:vlt-0005.lev";
read 'File' (1089,"vlt-0006.lev") ":lib:vlt-0006.lev";
read 'File' (1090,"vlt-0007.lev") ":lib:vlt-0007.lev";
read 'File' (1091,"vlt-0008.lev") ":lib:vlt-0008.lev";
read 'File' (1092,"vlt-0009.lev") ":lib:vlt-0009.lev";
read 'File' (1093,"vlt-0010.lev") ":lib:vlt-0010.lev";
read 'File' (1094,"vlt-0011.lev") ":lib:vlt-0011.lev";
read 'File' (1095,"vlt-0012.lev") ":lib:vlt-0012.lev";
read 'File' (1096,"vlt-0013.lev") ":lib:vlt-0013.lev";
read 'File' (1097,"vlt-0014.lev") ":lib:vlt-0014.lev";
read 'File' (1098,"vlt-0015.lev") ":lib:vlt-0015.lev";
read 'File' (1099,"vlt-0016.lev") ":lib:vlt-0016.lev";
read 'File' (1100,"vlt-0017.lev") ":lib:vlt-0017.lev";
read 'File' (1101,"vlt-0018.lev") ":lib:vlt-0018.lev";
read 'File' (1102,"vlt-0019.lev") ":lib:vlt-0019.lev";
read 'File' (1103,"vlt-0020.lev") ":lib:vlt-0020.lev";
read 'File' (1104,"vlt-0021.lev") ":lib:vlt-0021.lev";
read 'File' (1105,"vlt-0022.lev") ":lib:vlt-0022.lev";
read 'File' (1106,"vlt-0023.lev") ":lib:vlt-0023.lev";
read 'File' (1107,"vlt-0024.lev") ":lib:vlt-0024.lev";
read 'File' (1108,"vlt-0025.lev") ":lib:vlt-0025.lev";
read 'File' (1109,"vlt-0026.lev") ":lib:vlt-0026.lev";
read 'File' (1110,"vlt-0027.lev") ":lib:vlt-0027.lev";
read 'File' (1111,"vlt-0028.lev") ":lib:vlt-0028.lev";
read 'File' (1112,"vlt-0029.lev") ":lib:vlt-0029.lev";
read 'File' (1113,"vlt-0030.lev") ":lib:vlt-0030.lev";
read 'File' (1114,"vlt-0031.lev") ":lib:vlt-0031.lev";
read 'File' (1115,"water.lev") ":lib:water.lev";
read 'File' (1116,"wizard1.lev") ":lib:wizard1.lev";
read 'File' (1117,"wizard2.lev") ":lib:wizard2.lev";
read 'File' (1118,"wizard3.lev") ":lib:wizard3.lev";
read 'File' (1119,"yeenoghu.lev") ":lib:yeenoghu.lev";
