...
read 'File' (1220,"Dkn-fila.lev") "Dkn-fila.lev";
read 'File' (1221,"Dkn-filb.lev") "Dkn-filb.lev";
read 'File' (1222,"Dkn-goal.lev") "Dkn-goal.lev";
read 'File' (1223,"Dkn-loca.lev") "Dkn-loca.lev";
read 'File' (1224,"Dkn-strt.lev") "Dkn-strt.lev";
read 'File' (1225,"Dru-fila.lev") "Dru-fila.lev";
read 'File' (1226,"Dru-filb.lev") "Dru-filb.lev";
read 'File' (1227,"Dru-goal.lev") "Dru-goal.lev";
read 'File' (1228,"Dru-loca.lev") "Dru-loca.lev";
read 'File' (1229,"Dru-strt.lev") "Dru-strt.lev";
read 'File' (1230,"Hea-fila.lev") "Hea-fila.lev";
read 'File' (1231,"Hea-filb.lev") "Hea-filb.lev";
read 'File' (1232,"Hea-goal.lev") "Hea-goal.lev";
read 'File' (1233,"Hea-loca.lev") "Hea-loca.lev";
read 'File' (1234,"Hea-strt.lev") "Hea-strt.lev";
read 'File' (1235,"Inf-fila.lev") "Inf-fila.lev";
read 'File' (1236,"Inf-filb.lev") "Inf-filb.lev";
read 'File' (1237,"Inf-goal.lev") "Inf-goal.lev";
read 'File' (1238,"Inf-loca.lev") "Inf-loca.lev";
read 'File' (1239,"Inf-strt.lev") "Inf-strt.lev";
read 'File' (1240,"Kni-fila.lev") "Kni-fila.lev";
read 'File' (1241,"Kni-filb.lev") "Kni-filb.lev";
read 'File' (1242,"Kni-goal.lev") "Kni-goal.lev";
read 'File' (1243,"Kni-loca.lev") "Kni-loca.lev";
read 'File' (1244,"Kni-strt.lev") "Kni-strt.lev";
read 'File' (1245,"Mon-fila.lev") "Mon-fila.lev";
read 'File' (1246,"Mon-filb.lev") "Mon-filb.lev";
read 'File' (1247,"Mon-goal.lev") "Mon-goal.lev";
read 'File' (1248,"Mon-loca.lev") "Mon-loca.lev";
read 'File' (1249,"Mon-strt.lev") "Mon-strt.lev";
read 'File' (1250,"Pri-fila.lev") "Pri-fila.lev";
read 'File' (1251,"Pri-filb.lev") "Pri-filb.lev";
read 'File' (1252,"Pri-goal.lev") "Pri-goal.lev";
read 'File' (1253,"Pri-loca.lev") "Pri-loca.lev";
read 'File' (1254,"Pri-strt.lev") "Pri-strt.lev";
read 'File' (1255,"Ran-fila.lev") "Ran-fila.lev";
read 'File' (1256,"Ran-filb.lev") "Ran-filb.lev";
read 'File' (1257,"Ran-goal.lev") "Ran-goal.lev";
read 'File' (1258,"Ran-loca.lev") "Ran-loca.lev";
read 'File' (1259,"Ran-strt.lev") "Ran-strt.lev";
read 'File' (1260,"Rog-fila.lev") "Rog-fila.lev";
read 'File' (1261,"Rog-filb.lev") "Rog-filb.lev";
read 'File' (1262,"Rog-goal.lev") "Rog-goal.lev";
read 'File' (1263,"Rog-loca.lev") "Rog-loca.lev";
read 'File' (1264,"Rog-strt.lev") "Rog-strt.lev";
read 'File' (1265,"Sam-fila.lev") "Sam-fila.lev";
read 'File' (1266,"Sam-filb.lev") "Sam-filb.lev";
read 'File' (1267,"Sam-goal.lev") "Sam-goal.lev";
read 'File' (1268,"Sam-loca.lev") "Sam-loca.lev";
read 'File' (1269,"Sam-strt.lev") "Sam-strt.lev";
read 'File' (1270,"Tou-fila.lev") "Tou-fila.lev";
read 'File' (1271,"Tou-filb.lev") "Tou-filb.lev";
read 'File' (1272,"Tou-goal.lev") "Tou-goal.lev";
read 'File' (1273,"Tou-loca.lev") "Tou-loca.lev";
read 'File' (1274,"Tou-strt.lev") "Tou-strt.lev";
read 'File' (1275,"Val-fila.lev") "Val-fila.lev";
read 'File' (1276,"Val-filb.lev") "Val-filb.lev";
read 'File' (1277,"Val-goal.lev") "Val-goal.lev";
read 'File' (1278,"Val-loca.lev") "Val-loca.lev";
read 'File' (1279,"Val-strt.lev") "Val-strt.lev";
read 'File' (1280,"Wiz-fila.lev") "Wiz-fila.lev";
read 'File' (1281,"Wiz-filb.lev") "Wiz-filb.lev";
read 'File' (1282,"Wiz-goal.lev") "Wiz-goal.lev";
read 'File' (1283,"Wiz-loca.lev") "Wiz-loca.lev";
read 'File' (1284,"Wiz-strt.lev") "Wiz-strt.lev";
#else
...
read 'File' (1220,"Dkn-fila.lev") ":lib:Dkn-fila.lev";
read 'File' (1221,"Dkn-filb.lev") ":lib:Dkn-filb.lev";
read 'File' (1222,"Dkn-goal.lev") ":lib:Dkn-goal.lev";
read 'File' (1223,"Dkn-loca.lev") ":lib:Dkn-loca.lev";
read 'File' (1224,"Dkn-strt.lev") ":lib:Dkn-strt.lev";
read 'File' (1225,"Dru-fila.lev") ":lib:Dru-fila.lev";
read 'File' (1226,"Dru-filb.lev") ":lib:Dru-filb.lev";
read 'File' (1227,"Dru-goal.lev") ":lib:Dru-goal.lev";
read 'File' (1228,"Dru-loca.lev") ":lib:Dru-loca.lev";
read 'File' (1229,"Dru-strt.lev") ":lib:Dru-strt.lev";
read 'File' (1230,"Hea-fila.lev") ":lib:Hea-fila.lev";
read 'File' (1231,"Hea-filb.lev") ":lib:Hea-filb.lev";
read 'File' (1232,"Hea-goal.lev") ":lib:Hea-goal.lev";
read 'File' (1233,"Hea-loca.lev") ":lib:Hea-loca.lev";
read 'File' (1234,"Hea-strt.lev") ":lib:Hea-strt.lev";
read 'File' (1235,"Inf-fila.lev") ":lib:Inf-fila.lev";
read 'File' (1236,"Inf-filb.lev") ":lib:Inf-filb.lev";
read 'File' (1237,"Inf-goal.lev") ":lib:Inf-goal.lev";
read 'File' (1238,"Inf-loca.lev") ":lib:Inf-loca.lev";
read 'File' (1239,"Inf-strt.lev") ":lib:Inf-strt.lev";
read 'File' (1240,"Kni-fila.lev") ":lib:Kni-fila.lev";
read 'File' (1241,"Kni-filb.lev") ":lib:Kni-filb.lev";
read 'File' (1242,"Kni-goal.lev") ":lib:Kni-goal.lev";
read 'File' (1243,"Kni-loca.lev") ":lib:Kni-loca.lev";
read 'File' (1244,"Kni-strt.lev") ":lib:Kni-strt.lev";
read 'File' (1245,"Mon-fila.lev") ":lib:Mon-fila.lev";
read 'File' (1246,"Mon-filb.lev") ":lib:Mon-filb.lev";
read 'File' (1247,"Mon-goal.lev") ":lib:Mon-goal.lev";
read 'File' (1248,"Mon-loca.lev") ":lib:Mon-loca.lev";
read 'File' (1249,"Mon-strt.lev") ":lib:Mon-strt.lev";
read 'File' (1250,"Pri-fila.lev") ":lib:Pri-fila.lev";
read 'File' (1251,"Pri-filb.lev") ":lib:Pri-filb.lev";
read 'File' (1252,"Pri-goal.lev") ":lib:Pri-goal.lev";
read 'File' (1253,"Pri-loca.lev") ":lib:Pri-loca.lev";
read 'File' (1254,"Pri-strt.lev") ":lib:Pri-strt.lev";
read 'File' (1255,"Ran-fila.lev") ":lib:Ran-fila.lev";
read 'File' (1256,"Ran-filb.lev") ":lib:Ran-filb.lev";
read 'File' (1257,"Ran-goal.lev") ":lib:Ran-goal.lev";
read 'File' (1258,"Ran-loca.lev") ":lib:Ran-loca.lev";
read 'File' (1259,"Ran-strt.lev") ":lib:Ran-strt.lev";
read 'File' (1260,"Rog-fila.lev") ":lib:Rog-fila.lev";
read 'File' (1261,"Rog-filb.lev") ":lib:Rog-filb.lev";
read 'File' (1262,"Rog-goal.lev") ":lib:Rog-goal.lev";
read 'File' (1263,"Rog-loca.lev") ":lib:Rog-loca.lev";
read 'File' (1264,"Rog-strt.lev") ":lib:Rog-strt.lev";
read 'File' (1265,"Sam-fila.lev") ":lib:Sam-fila.lev";
read 'File' (1266,"Sam-filb.lev") ":lib:Sam-filb.lev";
read 'File' (1267,"Sam-goal.lev") ":lib:Sam-goal.lev";
read 'File' (1268,"Sam-loca.lev") ":lib:Sam-loca.lev";
read 'File' (1269,"Sam-strt.lev") ":lib:Sam-strt.lev";
read 'File' (1270,"Tou-fila.lev") ":lib:Tou-fila.lev";
read 'File' (1271,"Tou-filb.lev") ":lib:Tou-filb.lev";
read 'File' (1272,"Tou-goal.lev") ":lib:Tou-goal.lev";
read 'File' (1273,"Tou-loca.lev") ":lib:Tou-loca.lev";
read 'File' (1274,"Tou-strt.lev") ":lib:Tou-strt.lev";
read 'File' (1275,"Val-fila.lev") ":lib:Val-fila.lev";
read 'File' (1276,"Val-filb.lev") ":lib:Val-filb.lev";
read 'File' (1277,"Val-goal.lev") ":lib:Val-goal.lev";
read 'File' (1278,"Val-loca.lev") ":lib:Val-loca.lev";
read 'File' (1279,"Val-strt.lev") ":lib:Val-strt.lev";
read 'File' (1280,"Wiz-fila.lev") ":lib:Wiz-fila.lev";
read 'File' (1281,"Wiz-filb.lev") ":lib:Wiz-filb.lev";
read 'File' (1282,"Wiz-goal.lev") ":lib:Wiz-goal.lev";
read 'File' (1283,"Wiz-loca.lev") ":lib:Wiz-loca.lev";
read 'File' (1284,"Wiz-strt.lev") ":lib:Wiz-strt.lev";
#endif
