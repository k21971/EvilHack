...
static NEARDATA const int nasties[] = {
    ...
    PM_WINGED_GARGOYLE, PM_STORM_GIANT, PM_OLOG_HAI, PM_ELF_LORD,
    PM_ELVEN_KING, PM_OGRE_KING, PM_HUMAN_CAPTAIN, PM_GREMLIN,
    PM_HILL_GIANT_SHAMAN, PM_ELF_LADY, PM_ELVEN_QUEEN, PM_OGRE_QUEEN,
    /* lawful */
