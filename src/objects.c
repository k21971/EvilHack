...
TOOL("spear trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, HI_WOOD),
TOOL("sleeping gas trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, HI_ZAP),
TOOL("fire trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, CLR_ORANGE),
TOOL("ice trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, CLR_BRIGHT_CYAN),
TOOL("teleportation trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, CLR_MAGENTA),
TOOL("magic trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, HI_ZAP),
TOOL("anti-magic trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, HI_ZAP),
TOOL("polymorph trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, CLR_BRIGHT_GREEN),
TOOL("magic beam trap", None,
     1, 0, 0, 0,   0,  50,  20, IRON, CLR_YELLOW),
/* instruments */
