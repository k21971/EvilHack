...
WEAPON("elven spear", "runed spear",
       0, 1, 0, 0, 10,  30,   3,  7,  8, 0, P,   P_SPEAR, WOOD, HI_WOOD),
...
WEAPON("elven dagger", "runed dagger",
       0, 1, 0, 0, 10,  10,   4,  5,  3, 2, P,   P_DAGGER, WOOD, HI_WOOD),
...
WEAPON("elven short sword", "runed short sword",
       0, 0, 0, 0,  2,  30,  10,  8,  8, 0, P,   P_SHORT_SWORD, WOOD, HI_WOOD),
...
TOOL("barding",             None, 1, 0, 0, 0,   4, 250, 300, IRON, HI_METAL),
TOOL("spiked barding",      None, 1, 0, 0, 0,   2, 275, 300, IRON, HI_METAL),
TOOL("barding of reflection", "polished barding",
     0, 0, 1, 0,   1, 250, 600, SILVER, HI_METAL),
...
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  43,  1, 2, 1, NODIR, HI_LEATHER),
SPELL("healing",         "white",
