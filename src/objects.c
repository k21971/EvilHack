...
ARMOR("crystal plate mail", None,
      1, 0, 1,  0, 15, 5, 300, 820,  3, 2,  ARM_SUIT, GLASS, CLR_WHITE),
ARMOR("bronze plate mail", None, /* bronze is more dense that iron */
      1, 0, 1,  0, 30, 5, 375, 400,  4, 1,  ARM_SUIT, COPPER, HI_COPPER),
...
ARMOR("dwarvish mithril-coat", None,
      1, 0, 0,  0, 10, 1, 125, 240,  4, 2,  ARM_SUIT, MITHRIL, HI_SILVER),
ARMOR("elven mithril-coat", None,
      1, 0, 0,  0, 15, 1, 115, 240,  5, 2,  ARM_SUIT, MITHRIL, HI_SILVER),
...
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 50,  1, 2, 1, RAY, HI_PAPER),
