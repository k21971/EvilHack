...
TOOL("pan flute",           None, 0, 0, 0, 0,   0,   6,  24, WOOD, HI_WOOD),
...
SPELL("magic missile",    "vellum",
      P_ATTACK_SPELL,      30,  2, 2, 1, RAY, HI_LEATHER),
...
SPELL("light",            "cloth",
      P_DIVINATION_SPELL,  30,  1, 1, 1, NODIR, HI_CLOTH),
SPELL("detect monsters",  "leathery",
      P_DIVINATION_SPELL,  30,  1, 2, 1, NODIR, HI_LEATHER),
SPELL("healing",          "white",
      P_HEALING_SPELL,     30,  2, 1, 1, IMMEDIATE, CLR_WHITE),
SPELL("knock",            "pink",
      P_MATTER_SPELL,      30,  1, 1, 1, IMMEDIATE, CLR_BRIGHT_MAGENTA),
...
SPELL("entangle",         "singed",
      P_EVOCATION_SPELL,   10,  1, 1, 1, IMMEDIATE, CLR_BRIGHT_BLUE),
SPELL("barkskin",         "torn",
...
SPELL("summon animal",    "blood-stained",
      P_EVOCATION_SPELL,   10,  4, 3, 1, NODIR, CLR_RED),
