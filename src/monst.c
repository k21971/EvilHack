...
#define SEDUCTION_ATTACKS_NO                                      \
     ...
     * mplayer classes
     */
    MON("human archeologist", S_HUMAN, LVL(10, 15, 10, 1, 3), (G_NOGEN | 1),
    ...
    MON("human barbarian", S_HUMAN, LVL(10, 15, 10, 1, -3), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE, 0,
         MH_HUMAN, 12, CLR_YELLOW),
    MON("human caveman", S_HUMAN, LVL(10, 15, 10, 0, 1), (G_NOGEN | 1),
    ...
    MON("human cavewoman", S_HUMAN, LVL(10, 15, 10, 0, 1), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_SAMU, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human healer", S_HUMAN, LVL(10, 12, 10, 1, 0), (G_NOGEN | 1),
    ...
    MON("human knight", S_HUMAN, LVL(10, 15, 10, 1, 3), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human dark knight", S_HUMAN, LVL(10, 15, 10, 1, -3), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human monk", S_HUMAN, LVL(10, 12, 10, 2, 0), (G_NOGEN | 1),
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT | M2_MALE,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human priest", S_HUMAN, LVL(10, 12, 10, 2, 0), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_MAGC, AD_CLRC, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human priestess", S_HUMAN, LVL(10, 12, 10, 2, -2), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_MAGC, AD_CLRC, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human ranger", S_HUMAN, LVL(10, 12, 10, 2, -3), (G_NOGEN | 1),
        ...
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human rogue", S_HUMAN, LVL(10, 12, 10, 1, -3), (G_NOGEN | 1),
    ...
    MON("human samurai", S_HUMAN, LVL(10, 15, 10, 1, 3), (G_NOGEN | 1),
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human tourist", S_HUMAN, LVL(10, 12, 10, 1, 0), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human valkyrie", S_HUMAN, LVL(10, 15, 10, 1, 1), (G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_SAMU, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_COLD, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human wizard", S_HUMAN, LVL(10, 12, 10, 3, 0), (G_NOGEN | 1),
