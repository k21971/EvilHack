...
struct permonst _mons2[] = {
   ...
   MON("snark", S_JABBERWOCK,
     ...
     * Zombies
     */
    MON("kobold zombie", S_ZOMBIE, LVL(0, 6, 10, 0, -3),
        (G_GENO | G_LGROUP | 3),
        A(ATTK(AT_CLAW, AD_DISE, 1, 4), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        M4_VULNERABLE_FIRE, MH_UNDEAD, 1, CLR_BROWN),
    MON("gnome zombie", S_ZOMBIE, LVL(1, 6, 10, 0, -3),
        (G_GENO | G_LGROUP | 3),
        A(ATTK(AT_CLAW, AD_DISE, 1, 5), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
    ...
    MON("orc zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        A(ATTK(AT_CLAW, AD_DISE, 1, 6), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(850, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
    ...
    MON("hobbit zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_DISE, 1, 6), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(850, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("elf zombie", S_ZOMBIE, LVL(3, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_DISE, 1, 7), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 175, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON,
    ...
    MON("human zombie", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        ...
        A(ATTK(AT_CLAW, AD_DISE, 1, 8), ATTK(AT_BITE, AD_DRIN, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("ettin zombie", S_ZOMBIE, LVL(6, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 10), ATTK(AT_CLAW, AD_DISE, 1, 6),
    ...
    MON("giant zombie", S_ZOMBIE, LVL(8, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_DISE, 1, 10),
    ...
    MON("Medusa", S_HUMAN, LVL(20, 12, 2, 50, -15), (G_NOGEN | G_UNIQ),
        ...
        M3_WAITFORU | M3_INFRAVISIBLE, 0, 0, 25, CLR_BRIGHT_GREEN),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("barbarian", S_HUMAN, LVL(10, 15, 10, 1, 0), (1),
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_COVETOUS, 0,
         MH_HUMAN, 12, CLR_YELLOW),
    MON("caveman", S_HUMAN, LVL(10, 15, 10, 0, 1), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_COVETOUS, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("cavewoman", S_HUMAN, LVL(10, 15, 10, 0, 1), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("healer", S_HUMAN, LVL(10, 12, 10, 1, 0), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_CLRC, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_COVETOUS,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("knight", S_HUMAN, LVL(10, 15, 10, 1, 3), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("ranger", S_HUMAN, LVL(10, 12, 10, 2, -3), (1),
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH | M3_COVETOUS,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("rogue", S_HUMAN, LVL(10, 12, 10, 1, -3), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_SITM, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_COVETOUS, 0, MH_HUMAN, 12, HI_DOMESTIC),
    MON("samurai", S_HUMAN, LVL(10, 15, 10, 1, 3), (1),
    ...
    MON("tourist", S_HUMAN, LVL(10, 12, 10, 1, 0), (1),
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_COVETOUS,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("valkyrie", S_HUMAN, LVL(10, 15, 10, 1, -1), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("wizard", S_HUMAN, LVL(10, 12, 10, 3, 0), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_SPEL, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
