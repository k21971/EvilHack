...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("Yeenoghu", S_DEMON, LVL(56, 18, -5, 80, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_CONF, 2, 8),
    ...
    MON("Lolth", S_DEMON, LVL(67, 12, -10, 70, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_BITE, AD_DRST, 4, 6), ATTK(AT_BITE, AD_PLYS, 3, 4),
    ...
    MON("Dispater", S_DEMON, LVL(78, 15, -2, 80, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 6), ATTK(AT_MAGC, AD_CLRC, 6, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Baalzebub", S_DEMON, LVL(89, 12, -5, 85, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_BITE, AD_DRST, 3, 6), ATTK(AT_GAZE, AD_STUN, 2, 6),
