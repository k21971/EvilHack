...
struct permonst _mons2[] = {
   ...
   MON("snark", S_JABBERWOCK, LVL(12, 18, 0, 30, 0), (2),
    ...
    MON("kobold mummy", S_MUMMY, LVL(3, 8, 6, 20, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_DRCO, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("gnome mummy", S_MUMMY, LVL(4, 10, 6, 20, -3),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_DRCO, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("elf mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_DRCO, 2, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("human mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_DRCO, 2, 4), ATTK(AT_CLAW, AD_DRCO, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("ettin mummy", S_MUMMY, LVL(7, 12, 4, 30, -6),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_DRCO, 2, 6), ATTK(AT_CLAW, AD_DRCO, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("giant mummy", S_MUMMY, LVL(8, 14, 3, 30, -7),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_DRCO, 3, 4), ATTK(AT_CLAW, AD_CLOB, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
