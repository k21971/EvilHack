...
static struct Bool_Opt {
    ...
    { "hilite_hidden_stairs", &iflags.hilite_hidden_stairs, FALSE, SET_IN_GAME },
    ...
    { "showdamage", &iflags.showdamage, FALSE, SET_IN_GAME },
    { "showexp", &flags.showexp, FALSE, SET_IN_GAME },
    { "showmondamage", &iflags.showmondamage, FALSE, SET_IN_WIZGAME },
...
STATIC_VAR const struct paranoia_opts {
    ...
    { PARANOID_AUTOALL, "Autoall", 2, "autoselect-all", 2,
      "y to pick filter choice 'A' for menustyle:Full" },
