...
static const NEARDATA short hwep[] = {
    ...
    TSURUGI, RUNESWORD, OBSIDIAN_SABER, DWARVISH_MATTOCK, MITHRIL_TWO_HANDED_SWORD, TWO_HANDED_SWORD,
    BATTLE_AXE, KATANA, UNICORN_HORN, CRYSKNIFE, TRIDENT, SILVER_LONG_SWORD, MITHRIL_LONG_SWORD, LONG_SWORD,
    ELVEN_BROADSWORD, BROADSWORD, SCIMITAR, SILVER_SABER, MORNING_STAR, ELVEN_SHORT_SWORD,
    DWARVISH_SHORT_SWORD, SHORT_SWORD, ORCISH_SHORT_SWORD, SILVER_MACE,
    MACE, AXE, DWARVISH_SPEAR, SILVER_SPEAR, ELVEN_SPEAR, SPEAR, ORCISH_SPEAR, FLAIL,
