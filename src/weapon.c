...
static const NEARDATA short hwep[] = {
    ...
    TSURUGI, RUNESWORD, DWARVISH_MATTOCK, MITHRIL_TWO_HANDED_SWORD, TWO_HANDED_SWORD, BATTLE_AXE,
    KATANA, UNICORN_HORN, CRYSKNIFE, TRIDENT, SILVER_LONG_SWORD, MITHRIL_LONG_SWORD, LONG_SWORD,
