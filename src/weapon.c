...
static const NEARDATA short hwep[] = {
    ...
    TSURUGI, RUNESWORD, TRIPLE_HEADED_FLAIL, ATLATL, HEAVY_MACE, HEAVY_WAR_HAMMER, LONG_SWORD,
    DWARVISH_MATTOCK, TWO_HANDED_SWORD, BATTLE_AXE, KATANA, ELVEN_LONG_SWORD, UNICORN_HORN,
    CRYSKNIFE, TRIDENT, BULLWHIP, ELVEN_BROADSWORD, BROADSWORD, SCIMITAR, MORNING_STAR,
