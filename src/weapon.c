...
static const NEARDATA short hwep[] = {
    ...
    BATTLE_AXE, KATANA, SILVER_MACE, UNICORN_HORN, CRYSKNIFE, TRIDENT, ELVEN_BROADSWORD,
    BROADSWORD, SCIMITAR, MORNING_STAR, ELVEN_SHORT_SWORD, DWARVISH_SHORT_SWORD, SHORT_SWORD,
    ORCISH_SHORT_SWORD, MACE, AXE, DWARVISH_SPEAR, SILVER_SPEAR, ELVEN_SPEAR, SPEAR,
