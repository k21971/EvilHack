...
/* Weapons in order of preference, primarily based on effective
   damage output (with some exceptions) */
static const NEARDATA short hwep[] = {
    ...
    CRYSKNIFE, HALBERD, TRIDENT, SPETUM, BEC_DE_CORBIN, LONG_SWORD,
    ORCISH_LONG_SWORD, ATLATL, HEAVY_WAR_HAMMER, DWARVISH_BEARDED_AXE,
    DARK_ELVEN_BROADSWORD, ELVEN_BROADSWORD, BROADSWORD, BARDICHE,
    BILL_GUISARME, RANSEUR, VOULGE, GUISARME, LUCERN_HAMMER, SCIMITAR,
    ORCISH_SCIMITAR, SABER, MORNING_STAR, ORCISH_MORNING_STAR,
    DARK_ELVEN_SHORT_SWORD, ELVEN_SHORT_SWORD, DWARVISH_SHORT_SWORD,
    SHORT_SWORD, ORCISH_SHORT_SWORD, ROD, DARK_ELVEN_MACE, MACE, AXE,
    GLAIVE, PARTISAN, FAUCHARD, DWARVISH_SPEAR, DARK_ELVEN_SPEAR,
    ELVEN_SPEAR, SPEAR, ORCISH_SPEAR, FLAIL, BULLWHIP, QUARTERSTAFF,
    JAVELIN, AKLYS, CLUB, PICK_AXE, RUBBER_HOSE, WAR_HAMMER,
    DARK_ELVEN_DAGGER, ELVEN_DAGGER, DAGGER, ORCISH_DAGGER, ATHAME,
    SCALPEL, KNIFE, STILETTO, WORM_TOOTH
};
