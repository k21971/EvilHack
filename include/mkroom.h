...
enum roomtype_types {
    ...
    GARDEN     = 17, /* nymphs, trees, grass, and fountains */
    FOREST     = 18, /* plant-like creatures, trees, grass */
    LEMUREPIT  = 19, /* contains lemures and horned devils */
    RNDVAULT   = 20, /* random vault, not to be confused with VAULT */
