...
enum statusfields {
    ...
    BL_XP, BL_AC, BL_MC, BL_TOHIT, BL_HD, BL_TIME, BL_REALTIME, BL_HUNGER, /* 13..20 */
    BL_HP, BL_HPMAX, BL_LEVELDESC, BL_EXP, BL_CONDITION, /* 21..25 */
    MAXBLSTATS /* [26] */
};
...
#define BL_MASK_PHASING         0x00008000L
