...
E long FDECL(enforce_oprops_mutex, (long));
...
E boolean FDECL(hitfloor, (struct obj *, BOOLEAN_P));
...
E boolean FDECL(In_purgatory, (d_level *));
E boolean FDECL(In_hdgn, (d_level *));
...
E boolean FDECL(rloc_engr, (struct engr *));
...
E boolean FDECL(may_passtree, (XCHAR_P, XCHAR_P));
...
E short FDECL(mchoose_learned_spell, (struct monst *, struct monst *,
                                      int, int, BOOLEAN_P));
...
E int FDECL(meatfood, (struct monst *));
...
E boolean FDECL(damage_mon_nonlethal, (struct monst*, int, int, BOOLEAN_P));
...
E void FDECL(init_mplayer_erac, (struct monst *, BOOLEAN_P));
...
E boolean FDECL(mcast_immediate_spell, (struct monst *, int, int, int));
...
E void NDECL(druid_wildshape);
E void NDECL(vampire_shapechange);
...
#endif
E void FDECL(litroom, (BOOLEAN_P, BOOLEAN_P, struct obj *, XCHAR_P, XCHAR_P));
...
E void FDECL(cast_reflection, (struct monst *, int));
E void FDECL(cast_barkskin, (struct monst *, int));
E void FDECL(cast_stoneskin, (struct monst *, int));
E void FDECL(cast_entangle, (struct monst *, int));
E int FDECL(cast_metal_to_wood, (struct obj *, BOOLEAN_P));
E void FDECL(grow_grass, (int, int, genericptr_t));
E void FDECL(cast_create_grass, (int));
E void FDECL(grow_tree, (int, int, genericptr_t));
E void FDECL(cast_create_trees, (int));
...
E boolean FDECL(enexto_core_mon, (coord *, XCHAR_P, XCHAR_P,
...
E char *FDECL(get_rnd_tt_name, (BOOLEAN_P));
...
E struct obj *FDECL(select_offhand_hwep, (struct monst *));
E boolean FDECL(can_dual_wield, (struct monst *));
E int FDECL(mon_wield_offhand, (struct monst *));
E void FDECL(possibly_unwield, (struct monst *, BOOLEAN_P));
E void FDECL(mwepgone, (struct monst *));
E void FDECL(mwep2gone, (struct monst *));
...
E int FDECL(weapon_skill_level, (struct obj *));
...
E void FDECL(setmnotwielded2, (struct monst *, struct obj *));
...
E boolean FDECL(melt_ice, (XCHAR_P, XCHAR_P, const char *));
