...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Werebane", SCIMITAR, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAGH), 0, MH_WERE,
    ...
    A("Angelslayer", TRIDENT,
      ...
      MH_ANGEL | MH_AASIMAR, FIRE(5, 10), NO_DFNS, NO_CARY, 0, A_NONE,
      NON_PM, NON_PM, 5000L, NO_COLOR, DEFAULT_MAT),
    ...
    /* Ithilmar is a set of barding that can be created by forging
       Vorpal Blade and Dramborleg together. It grants the steed that
       wears it reflection, magic resistance, and several other benefits
       that will help keep the steed alive */
