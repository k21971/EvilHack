...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    /* Temporary debug for glowwarn testing. REMOVE when no longer needed for testing! */
    A("GThing", AMULET_OF_REFLECTION, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAGH), 0, MH_GNOME,
      NO_ATTK, NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 3000L, CLR_CYAN),
    A("DThing", RIN_SLOW_DIGESTION, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAGH), 0, MH_DWARF,
      NO_ATTK, NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 3000L, CLR_RED),
    A("D2Thing", RIN_CONFLICT, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAGH), 0, MH_DWARF,
      NO_ATTK, NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 3000L, CLR_RED),
    A("CEThing", RIN_PROTECTION, (SPFX_RESTR | SPFX_WARN | SPFX_DFLAGH), 0, MH_CENTAUR | MH_ELF,
      NO_ATTK, NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 3000L, CLR_YELLOW),
